// UnknownError import removed - was unused
...
/**
 * This utility safely handles unknown client input by checking if it's an object
 * and contains the specified key before attempting to access the property.
 * Used to prevent runtime errors when processing form data or API inputs.
 */
export const flattenClientInputValue = (clientInput: unknown, key: string): string | undefined => {
