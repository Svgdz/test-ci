...
export const USER_MESSAGES = {
  ...
  signUpEmailAlternate: {
    message: 'Is this a secondary email? Use your primary email for fast access.',
    timeoutMs: 30000,
  },
  nameUpdated: {
  ...
  ProjectLogoUpdated: {
    message: 'Your Project logo has been updated.',
  },
  failedUpdateName: {
...
export const getTimeoutMsFromUserMessage = (message: string): number | undefined => {
  const messageConfig: UserMessageConfig | undefined = Object.values(USER_MESSAGES).find(
    (m) => m.message === message
  )
